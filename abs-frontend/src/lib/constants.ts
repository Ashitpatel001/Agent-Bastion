...
export const NAVIGATION_ITEMS: NavigationItem[] = [
  ...
  },
  {
    ...
    icon: 'Users',
    roles: [UserRole.OWNER, UserRole.ADMIN, UserRole.DEVELOPER, UserRole.SECURITY_ANALYST, UserRole.VIEWER],
  },
  {
    title: 'Tasks',
    href: '/dashboard/tasks',
    icon: 'Activity',
    roles: [UserRole.OWNER, UserRole.ADMIN, UserRole.DEVELOPER, UserRole.OPERATOR, UserRole.VIEWER],
  },
  {
    title: 'Workers',
    href: '/dashboard/workers',
    icon: 'Cpu',
    roles: [UserRole.OWNER, UserRole.ADMIN, UserRole.DEVELOPER, UserRole.OPERATOR],
  },
  {
    title: 'Queues',
  ...
  },
  {
    ...
    icon: 'ShieldCheck',
    roles: [UserRole.OWNER, UserRole.ADMIN, UserRole.SECURITY_ANALYST, UserRole.DEVELOPER],
  },
  {
    title: 'Metrics',
    href: '/dashboard/metrics',
    icon: 'Activity',
    roles: [UserRole.OWNER, UserRole.ADMIN, UserRole.SECURITY_ANALYST, UserRole.DEVELOPER, UserRole.OPERATOR, UserRole.VIEWER],
  },
  {
    title: 'Observability',
